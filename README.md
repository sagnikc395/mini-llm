...
3. [Scaling Book](https://jax-ml.github.io/scaling-book/) , tbh this is a future reading for me that I plan to read (sometime ig), but it seems that at lot of production level code is written in Jax.
